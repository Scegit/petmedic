	...
	<div class="container-fluid" style="width:90%">
		...
		<form action="insertDoc" method="POST" enctype="multipart/form-data">
			<div class="input-group mb-3"	>
				...
				<input type="text" class="form-control innm" name="doc_hos_id" value="${hos.hos_id}" required>
			</div>
			<br>
			<div class="input-group mb-3"	>
			<div class="input-group-prepend">
		...
		<form action="insertDoc" method="POST" enctype="multipart/form-data">
			...
			<div class="mobileinputboxinsertdoc">
				<input type="file" class="form-control" name="uploadFile" value="${doc.doc_filename}" required>
				</div>
			</div>
			<br>
			<div class="input-group mb-3"	>
