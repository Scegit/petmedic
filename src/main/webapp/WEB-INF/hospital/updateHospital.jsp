...
<h3 class="hname">병원 수정페이지</h3> 
  ...
  <input type="hidden" name="hos_id" value="${hospital.hos_id}">
    <div class="input-group mb-3" id="hosmb">
      ...
      <input type="text" class="form-control innm" name="hos_name" value="${hospital.hos_name}" placeholder="수정하실 부분을 입력 해주세요" required<%//=sts %>>      
    </div>
    <div class="input-group mb-3" id="hosmb">
    <div class="input-group-prepend" id="hosdivspan">
    <span class="input-group-text" id="hosspan">연락처</span> </div>  
     <input type="text" class="form-control innm" name="hos_tel" value="${hospital.hos_tel}"placeholder="수정하실 부분을 입력 해주세요" required<%//=sts %>>      
     </div>
 
     <div class="input-group mb-3" id="hosmb">
      <div class="input-group-prepend" id="hosdivspan">
        <span class="input-group-text">우편번호</span>      </div> 
        <input type="text" class="form-control innm" name="hos_addr" value="${hospital.hos_addr}" placeholder="수정하실 부분을 입력 해주세요" required<%//=sts %>> 

     </div>
     <div class="input-group mb-3" id="hosmb">
      <div class="input-group-prepend" id="hosdivspan">
        <span class="input-group-text">도로명주소</span> </div> 
            <input type="text" class="form-control innm" name="hos_addr2" value="${hospital.hos_addr2}" placeholder="수정하실 부분을 입력 해주세요" <%//=sts %>> 
     
     </div>
     <div class="input-group mb-3" id="hosmb">
      <div class="input-group-prepend" id="hosdivspan">
        <span class="input-group-text">지번주소</span> </div> 
           <input type="text" class="form-control innm" name="hos_addr3" value="${hospital.hos_addr3}" placeholder="수정하실 부분을 입력 해주세요" <%//=sts %>> 
     
     </div>
     <div class="input-group mb-3" id="hosmb">
      <div class="input-group-prepend" id="hosdivspan">
        <span class="input-group-text">상세주소</span>  </div> 
           <input type="text" class="form-control innm" name="hos_addr4" value="${hospital.hos_addr4}" placeholder="수정하실 부분을 입력 해주세요" <%//=sts %>> 
    
     </div>
     <div class="input-group mb-3" id="hosmb">
      <div class="input-group-prepend" id="hosdivspan">
        <span class="input-group-text">참고사항</span></div> 
          <input type="text" class="form-control innm" name="hos_addr5" value="${hospital.hos_addr5}" placeholder="수정하실 부분을 입력 해주세요" <%//=sts %>> 
    ...
    <div class="input-group mb-3" id="hosmb">
      ...
      <input type="button" class="form-control innm" name="hos_url" value="${hospital.hos_url}" placeholder="수정하실 부분을 입력 해주세요" > 
    ...
    <div class="input-group-prepend" id="hosdivspan">
     <span class="input-group-text">진료동물</span>
      ...
      <input type="text" class="form-control innm" name="hos_cate" value="${hospital.hos_cate}" placeholder="수정하실 부분을 입력 해주세요"  required<%//=sts %>>      
    </div>
    <div class="input-group mb-3" id="hosmb">
    <div class="input-group-prepend" id="hosdivspan">
     <span class="input-group-text">진료시간</span>
      </div>
      <input type="text" class="form-control innm" name="hos_start" value="${fn:substring(hospital.hos_start,0,5)}" placeholder="수정하실 부분을 입력 해주세요"<%//=sts%>required> ~
     ...
     <div class="input-group mb-3" id="hosmb">
      <div class="input-group-prepend" id="hosdivspan">
        <span class="input-group-text" id="hosspan">병원사진</span>
            ...
            <img src="${pageContext.request.contextPath}/img/${hospital.hos_pic}" alt="${hospital.hos_pic}" style="display: block" id="hos_pic">

       		 <input type="file" class="form-control innm" name="uploadFile" <%//=sts%>>    
      </div>  
...
<!--     </div>  -->
 ...
 <script>
  if ('${hospital.hos_role}' === 'Y') {
    document.querySelector('input[name="hos_role"]').value = '인증된 병원입니다.';
  }
</script> 
<h3 class=hend></h3>   
