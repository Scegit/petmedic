				...
				<div class="container" id="reportDtail">
					...
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text reportDtail_span">번호</span>
						</div>
					...
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text reportDtail_span">진행상태</span>
						</div>
						<input style="flex: 0.6 1 auto;" type="text"
		...
		<div class="modal-dialog" >
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text reportDtail_span">리뷰번호</span>
						</div>
					...
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text reportDtail_span">리뷰사진</span>
						</div>
						<div class="innm">
							<input class="form-control innm" type="hidden" name="rev_pic"
