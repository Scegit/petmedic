                  ...
                  $
                        .ajax({
                           ...
                           success : function(result) {
                              ...
                              table += '<table><tr><th>예약일자</th><th>병원명</th><th>별점</th></tr>';
                           ...
                           error : function(request, status) {
                              console.log("에러다");
                              var table = "";
                              table += '<table><tr><th>아직 작성된 리뷰가 없습니다</th></tr>';
                              $('.reviewtable').append(table);
   ...
   <div class="container structure myMainMenuWeb">
      ...
      <div id="menuDiv">
			...
			<div class="col-md-8 leftDiv">
					<span class="usermypage_title"><%=session.getAttribute("users_id")%>님 마이페이지</span>
				</div>
...
<!--                <div class="col title">내정보<span onclick="location.href='/getUsers'" >></span></div> -->
            ...
            <div class="col-md-6">
               <div class="col actiontitle actiontitlepetpet"> 
                  <div class="col"> 
                     <a onclick="location.href='/mypetlist'">마이펫</a>
                  </div>
                  <div class="col showMoreRevZzim">
                     <a onclick="location.href='/mypetlist'"> > </a>
                  </div>
               </div>
...
<!--                추가된 부분 펫이없습니다 or 펫사진 끌고오기 -->
               <c:choose>
					...
					<c:otherwise>
						<table class="tb-mypets" style="width:300px; text-align:center;">
							<tr>
								<c:forEach items ="${petsList}" var="pets" varStatus="status" end="3">
										<td class="tb-mypets-td">
									<c:choose>
											<c:when test="${empty pets.pet_pic}">
													<img style="width:70px; height:70px; border-radius:50%;"  src="../resources/imgs/noimg.png">
											</c:when>
											<c:otherwise>
													<img style="width:70px; height:70px; border-radius:50px;" src="../resources/imgs/${pets.pet_pic}">
											</c:otherwise>
									</c:choose>
										</td>
								</c:forEach>
   ...
   <!--             <div class="title actiontitle row"> -->
               <div class="col actiontitle actiontitlezzim">
                  <div class="col-9"> 
                     <a href="/myActionZzim">찜병원 <span class="myZzimRow myMainZzimColCnt">  <!-- 몇개 찜했는지 표시해줄 부분 --> </span ></a>
                  </div>
                  <div class="col-3 showMoreRevZzim">
                     <a href="/myActionZzim"> > </a>
                  </div>
               </div>
...
<!--                      </div> -->
         ...
         <div class="row mobilecontr1">
            <div class="col-md-6">
               <div class="col actiontitle actiontitlereserv"> 
                  <div class="col"> 
                     <a href="/myActionReserve">예약내역</a>
                  </div>
                  <div class="col showMoreRevZzim">
                    <a href="/myActionReserve"> > </a>
                  </div>
               </div>
               <div class="col blurblur myactionReservemain">
                  <table class="reserveMy">
                     <tr>
                        <th>방문예정일</th>
                        <th>병원명</th>
                        <th>예약상태</th>
            ...
            <!-- 예약내역 여기까지 -->
               ...
               <div class="col-md-6 leftp">
                  <div class="col actiontitle actiontitlereview"> 
                     <div class="col"> 
                        <a href="/getMyReviewPostList">나의리뷰</a>
                     </div>
                     <div class="col showMoreRevZzim">
                        <a href="/getMyReviewPostList"> > </a>
                     </div>
                  </div>
