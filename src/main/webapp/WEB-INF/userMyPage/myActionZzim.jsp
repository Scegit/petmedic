...
function delList(zzim, userList){
   ...
   $.each(userList, function(index, item) {
	  if(item.users_pick1 == null &&  item.users_pick2 == null && item.users_pick3 == null && item.users_pick4 == null && item.users_pick5 == null) {
		  zzimhtml += "<div class=\"row blurblur emptyResult\"><p>찜한 병원이 없습니다</p></div>"; 
		 }
      if(item.users_pick1){ 
         zzimhtml += "<div class=\"row blurblur\" id=\"actZzimList\"><div class=\"col-8\"><a onClick=\"getHosDetail('"+item.users_pick1+"')\">" 
         + zzim[0].users_hos_name1 + "</a></div>" + "<div class=\"col-4\" style=\"text-align:center;\">" 
         + "<button type=\"button\" class=\"btn\" id=\"zzimbtn\" onClick=\"delZzim('"+ item.users_pick1 +"', 'hos1')\"><span>삭제</span></button>" 
         + "</div></div>"; 
      }
      if(item.users_pick2){
         zzimhtml += "<div class=\"row blurblur\" id=\"actZzimList\"><div class=\"col-8\"><a onClick=\"getHosDetail('"+item.users_pick2+"')\">" 
         + zzim[0].users_hos_name2 + "</a></div>" + "<div class=\"col-4\" style=\"text-align:center;\">" 
         + "<button type=\"button\" class=\"btn\" id=\"zzimbtn\" onClick=\"delZzim('"+ item.users_pick2 +"', 'hos2')\"><span>삭제</span></button>" 
         + "</div></div>"; 
      }
      if(item.users_pick3){
         zzimhtml += "<div class=\"row blurblur\" id=\"actZzimList\"><div class=\"col-8\"><a onClick=\"getHosDetail('"+item.users_pick3+"')\">" 
         + zzim[0].users_hos_name3 + "</a></div>" + "<div class=\"col-4\" style=\"text-align:center;\">" 
         + "<button type=\"button\" class=\"btn\" id=\"zzimbtn\" onClick=\"delZzim('"+ item.users_pick3 +"', 'hos3')\"><span>삭제</span></button>" 
         + "</div></div>"; 
      }
      if(item.users_pick4){
         zzimhtml += "<div class=\"row blurblur\" id=\"actZzimList\"><div class=\"col-8\"><a onClick=\"getHosDetail('"+item.users_pick4+"')\">" 
         + zzim[0].users_hos_name4 + "</a></div>" + "<div class=\"col-4\" style=\"text-align:center;\">"  
         + "<button type=\"button\" class=\"btn\" id=\"zzimbtn\" onClick=\"delZzim('"+ item.users_pick4 +"', 'hos4')\"><span>삭제</span></button>" 
         + "</div></div>"; 
      }
      if(item.users_pick5){
         zzimhtml += "<div class=\"row blurblur\" id=\"actZzimList\"><div class=\"col-8\"><a onClick=\"getHosDetail('"+item.users_pick5+"')\">" 
         + zzim[0].users_hos_name5 + "</a></div>" + "<div class=\"col-4\" style=\"text-align:center;\">" 
         + "<button type=\"button\" class=\"btn\" id=\"zzimbtn\" onClick=\"delZzim('"+ item.users_pick5 +"', 'hos5')\"><span>삭제</span></button>" 
         + "</div></div>"; 
      }
   });
//       }
   ...
   <!-- 나의 찜 목록 -->
      <div class="myactionZzim container">
      		<div class="row zzimtitlerow">
      			<div class="col">
      				<strong>찜병원 목록보기</strong>
      			</div>
      			<div class="col">
      				<span>병원 찜은 최대 5개까지 가능합니다</span>
      			</div>
      		</div>
          <hr> 
         <!-- 찜병원 목록이 들어올 곳 -->
