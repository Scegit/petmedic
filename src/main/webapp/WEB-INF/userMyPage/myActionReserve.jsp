...
//       resvDetailseq = dataList[i].res_seq;
...
//          if (date2 > date1) {
            ...
            listHtml += "<div class=\"col-3 mibileActC\">"
               + "<button type=\"button\" class=\"btn resvDetail\" id=\"resvDetailbtn\" data-toggle=\"modal\" data-target=\"#resvDeModal\" onClick=\"resvDet("+ dataList[i].res_seq +")\"><span>상세" + br + "보기</span></button></div></div></div>";
      }
   }
} else {
      ...
      success: function(res) {
         ...
         var footerHtml = "";
           if ((res.res_cancel) == 'Y') {   // 취소된 예약내역일 경우 출력
              ...
              if (date2 > date1) {
                 footerHtml += "<button type=\"button\" class=\"btn resCancel\" id=\"resbtn\" onClick=\"resCancel("+ res.res_seq +")\" title=\"예약취소\"><span>예약취소</span></button>";
              }
              if (date2 < date1) {
                 var hasReview = filterList.some(item => item.res_seq == res.res_seq);
                 if (!hasReview) {
                    footerHtml += "<button class=\"revInsButn\" onClick=\"revIns(" + res.res_seq + ")\" title=\"리뷰쓰기\"><span>리뷰쓰기</span></button>";
                 } else {
...
<!-- 			<div class="col myResvSrch"> -->
<!-- 				<div class="row myResvSrchBTNdiv"> -->
<!-- 					<div class="col-4"> -->
<!-- 						<input class="form-control" id="searchInsertDate1" name="searchInsertDate1" placeholder="방문예정일"> -->
<!-- 					</div> -->
<!-- 					<div class="col-1">~</div> -->
<!-- 					<div class="col-4"> -->
<!-- 						<input class="form-control" id="searchInsertDate2" name="searchInsertDate2" placeholder="방문예정일"> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 				<div class="row myResvSrchBTNdiv"> -->
<!-- 					<button type="button" class="btn" id="myResvDateSearchButton" onclick="dateCheckResv(document.getElementById('searchInsertDate1').value, document.getElementById('searchInsertDate2').value)">기간검색</button> -->
<!-- 					<button type="button" class="btn" id="myResvDateSearchResetButton" onclick="resetSearchUserList()">검색 초기화</button> -->
<!-- 				</div> -->
<!-- 			</div> -->
		</div>
  ...
  <div class="modal-dialog modalRede">
    <div class="modal-content">
     ...
     <div class="resvMdFooter"></div>
      <button type="button" class="btn " id="modalCloseD" data-dismiss="modal">닫기</button>
      </div>
    </div>
  </div>
</div>
