...
<div class="usersjoin_content">
    <div id="navbarlogo1">
		<a href="index.jsp"> 
		<img style="width: 120px;"src="${pageContext.request.contextPath}/img/PetMedicLogo_P.png"></a>
	</div>
                ...
                <form class="needs-validation" action="joinUser" name="frm" id="joinForm" method="post" onsubmit="return formSubmit()" novalidate>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="id" name="users_id" placeholder="4자이상 16자 이하 입력" required>
                            <div class="input-group-append">
                                <button type="button" id="idCheck" class="btn btn-primary" onclick="checkDupId()">중복체크</button>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" name="users_pw" placeholder="8자이상 16자 이하 입력" pattern="[가-힣A-Za-z]{8,16}" required>
                        <span></span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control" id="phoneNumber" type="text" name="users_tel" placeholder="-를 제외한 숫자만 입력해주세요" maxlength="11" required>
                            <div class="input-group-append">
                                <button type="button" id="phoneChk" class="btn btn-primary" onclick="checkDupPhone()">인증번호 발송</button>
                            </div>
                        </div>
                        ...
                        <div class="input-group" id="phoneCheckDiv" style="display:none;margin-top: 5px;">
                            <input class="form-control" id="phone2" type="text" name="phone" placeholder="인증번호 입력해주세요"
                                   required>
                            <div class="input-group-append">
                                <input class="btn btn-primary" type="button" value="인증확인" id="phoneChk2" onclick="confirmPhone()">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <div class="input-group" style="margin-top: 5px;">
                                ...
                                <input type="text" class="form-control" id="sample4_detailAddress" placeholder="상세주소" name="users_addr4">
                            </div>
    ...
    <div class="input-group-append">
        <button type="button" class="btn btn-primary" id="mail-Check-Btn" onclick="checkDupEmail()">인증번호 발송</button>
    </div>
</div>
...
<span id="emailConfirmAlert"></span>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary" id="joinsubmit">가입하기</button>
                    </div>
...
function handleEmailOption(selectBox) {
	  ...
	  if (selectedOption === "direct") {
	    ...
	    var emailSelectOptions = ['@naver.com', '@daum.net', '@gmail.com', '@hanmail.net', '@yahoo.com', '직접입력'];
	    var emailSelectHtml = '<select class="form-control" name="users_email2" id="email2" onchange="handleEmailOption(this)">';

	    for (var i = 0; i < emailSelectOptions.length; i++) {
	      var optionValue = emailSelectOptions[i];
	      var optionHtml = '<option value="' + optionValue + '">' + optionValue + '</option>';
	      emailSelectHtml += optionHtml;
	    }

	    emailSelectHtml += '</select>';
	    email2Container.innerHTML = emailSelectHtml;

	    var newEmailSelect = email2Container.querySelector('select[name="users_email2"]');
	    newEmailSelect.value = selectedOption;
	  }
	}
