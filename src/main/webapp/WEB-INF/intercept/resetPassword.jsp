    ...
    <div class="forgotIdDiv">
        <div class="form-group">
            <div class="input-group">
                <input type="text" class="form-control" id="id" name="users_id" placeholder="아이디를 입력해주세요" required>
            </div>
        ...
        <div class="form-group resetDiv1">
            <div class="input-group">
                <input class="form-control" id="phoneNumber" type="text" name="users_tel" placeholder="전화번호 입력해주세요" required>
        ...
        <div class="form-group" id="resetDiv2" style="display:none">
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="password" name="users_pw" required>
                <span></span>
            </div>
