...
<body>
    ...
    <div class="forgotIdDiv">
                ...
                <input class="form-control" id="usersname" type="text" name="hos_name" placeholder="병원명 입력란" required> <!-- 추가 -->
                <span id="userNameAlert"></span><!-- 추가 -->
                    <div class="input-group" id="xxxx">
                        <input class="form-control" id="phoneNumber" type="text" name="hos_tel"placeholder="전화번호 입력란" required>
...
<script>
    function checkDupPhone() {
        ...
        if (userNameInput.val().trim() === "") {//추가
            $("#userNameAlert").html("병원명을 입력해주세요.").css("color","red");//추가
        ...
        $.ajax({
            ...
            data: {"hos_name": $("#usersname").val(),"hos_tel": $("#phoneNumber").val()}, //"users_name": $("#usersname").val(), 추가
            cache: false,
