...
<div class="container" align="center" style="max-width:768px;">
    <div class="forgotIdDiv">
        ...
        <div class="form-group resetDiv1">
            <div class="input-group">
                <input class="form-control" id="phoneNumber" type="text" name="hos_tel" placeholder="전화번호 입력해주세요" required>
...
<script>
    function checkDupPhone() {
        ...
        $.ajax({
            ...
            data: {"hos_id": id.val(), "hos_tel": $("#phoneNumber").val()},
            cache: false,
