...
<div id="mainMenuListUlDiv">
	<ul class="nav mainMenuList">
		...
		<li class="nav-item"><a href="about.jsp" class="nav-link petmedicnav-link"> <b id="navb">펫메딕소개</b></a></li>
		
		<li class="nav-item"><a href="insertHospital" class="nav-link petmedicnav-link"> <b id="navb">병원등록</b></a></li>
        ...
        <div class="modal-dialog">
          <div class="modal-content" id="loginmodal">
            ...
            <div class="form-group">
                ...
                <div class="text-right">
            <a href="insertHospital" id="loginmodaltxt" class="seonchanaclass">병원등록</a> | <a href="forgothosId" id="loginmodaltxt" class="seonchanaclass">아이디찾기</a> | <a href="resethosPassword" id="loginmodaltxt" class="seonchanaclass">비밀번호 재설정</a>
            <br><br> 
        </div>
