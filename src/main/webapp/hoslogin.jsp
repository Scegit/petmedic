            ...
            <c:choose>
               <c:when test="${users_id ne NULL}">
                  ...
                  <c:choose>
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="#" onclick="location.href='https://kauth.kakao.com/oauth/logout?client_id=1a705d08cde8b1fe4e40ecb2ddbe8d45&logout_redirect_uri=http://www.petmedic.kro.kr/kakaologout'">
                  로그아웃</a>
                     </li>
                     </c:when>
                     <c:otherwise>
