...
<footer>
	...
	<div>
		<div class="footerLogo" id="petMedicFooterImg">
			<img id="footerLogoImg" src="${pageContext.request.contextPath}/img/PetMedicLogo_P.png" />
		</div>
		<div class="footerLogo" id="petMedicFooterP">
			<p><span>P</span>et</p><br>
			<p><span>M</span>edic</p>
		</div>
	</div>
	...
	<!-- 연락할곳 -->
		...
		<p class="footerTitle">Contact Us</p>
			...
			<div id="footerAddrDiv">
				<svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="#5D3891" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
			...
			<!-- 연락처 -->
			<div id="footerTelDiv">
				<svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="#5D3891" class="bi bi-telephone-fill" viewBox="0 0 16 16">
			...
			<div id="footerEmailDiv">
				<svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="#5D3891" class="bi bi-envelope-at-fill" viewBox="0 0 16 16">
	...
	<!-- Copyright -->
		<div id="footerCopyright">
			...
			<p class="CopyTwo">Copyright &#169; 2023. Eight Vet. All right reserved.</p>
			</div>
		</div>
